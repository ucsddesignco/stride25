    ...
    return (
        <section id = "overview">
            <div className = "header">
                ...
                <p>STRIDE is Design Co’s uniquely design-forward career fair. Held once a year, STRIDE connects students with company representatives for a day of networking, resume reviews, and recruiting sessions designed to jump-start industry careers.</p>
            </div>
            <div className = "boxes-general">
                <Box 
                    icon={<OnetoOne />}
                    title="1:1 Networking"
                    variant="primary"
                />
